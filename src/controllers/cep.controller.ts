...
/**
 * POST /ceps/generate
 * Genera CEPs del día anterior (sin parámetros de fecha)
 */
...
/**
 * POST /ceps/generate-range
 * Genera CEPs desde un rango de fechas consultando la base de datos
 */
